...
def api_translate():
    ...
    try:
        ...
        if target_lang.lower() in ["odia", "oriya", "or"]:
            system_prompt += (
                "CRITICAL INSTRUCTION FOR NATIVE & PHONETIC ODIA:\n"
                "You MUST provide the translation in BOTH native Odia script (ଓଡ଼ିଆ ଅକ୍ଷର) AND phonetically transliterated Odia (WhatsApp chat style in Latin/English alphabet) on the bottom, separated exactly by a line containing '---'.\n"
                "Format your output exactly as:\n"
                "[Odia native script translation]\n"
                "---\n"
                "[Phonetic transliterated Odia in Latin alphabet]\n"
                "\n"
                "Rules for native translation:\n"
                "1. Translate strictly into normal, everyday Odia language, written entirely in native Odia script. Do NOT use English alphabet or Devanagari.\n"
                ...
                "   - NEVER use equivalents of the Hindi word 'bhukha' (for 'hungry'). You MUST use the Odia word 'ଭୋକ' (bhoka) (e.g., 'ମୋତେ ଭୋକ ଲାଗୁଛି' (Mote bhoka laguchi) instead of 'ମୁଁ ଭୁଖା ଲାଗିଛି').\n"
                ...
                "4. Ensure correct translation of homonyms and intentions ('want to do X'). Specifically:\n"
                "   - 'raga' (which can mean both anger and spicy flavor in Odia): 'I am angry' -> 'ମୁଁ ରାଗିଛି' or 'ମୋତେ ରାଗ ଲାଗୁଛି' (Never translate literally as eating anger like 'ମୁଁ ରାଗ ଖାଇଛି'); 'The food is spicy' -> 'ଖାଇବା ବହୁତ ରାଗ'.\n"
                "   - 'want to do X' (intentions): Translate as 'ମୁଁ X କରିବାକୁ ଚାହୁଁଛି' (Mu X karibaku chahunchhi). Specifically: 'I want to go' -> 'ମୁଁ ଯିବାକୁ ଚାହୁଁଛି' (Mu jibaku chahunchhi) (Never translate as 'ମୁଁ ଯାଇଛି' (Mu jaichi) which means 'I have gone'); 'I want to eat' -> 'ମୁଁ ଖାଇବାକୁ ଚାହୁଁଛି' (Mu khaibaku chahunchhi).\n"
                ...
                "   - 'I am hungry' -> 'ମୋତେ ଭୋକ ଲାଗୁଛି'\n"
                "   - 'I want to go to Rourkela to eat gupchup' -> 'ମୁଁ ଗୁପଚୁପ୍ ଖାଇବାକୁ ରାଉରକେଲା ଯିବାକୁ ଚାହୁଁଛି'\n"
                ...
                "\n"
                "Rules for phonetic transliteration:\n"
                "1. The phonetic transliterated text must be the exact same sentence as the native script but transliterated phonetically into standard chat-style English/Latin letters.\n"
                "2. Do NOT use native Odia characters or Devanagari script for the phonetic translation section below '---'.\n"
                "3. Reference translations for phonetic sentences:\n"
                "   - 'Subha sakala'\n"
                "   - 'Subha dwipahara'\n"
                "   - 'Subha sandhya'\n"
                "   - 'Subha ratri'\n"
                "   - 'Mu ragichhi'\n"
                "   - 'Mote bhoka laguchi'\n"
                "   - 'Mu gupchup khaibaku Rourkela jibaku chahunchhi'\n"
                "   - 'Ehi jagara sabuthu bhala khaiba kana?'\n"
                "   - 'Hi, mu Sarthak, tuma naa kana?'\n"
                "   - 'Tuma naa kana?' or 'Apananka naa kana?'\n"
                "   - 'Mora naa ...'\n"
                "   - 'Tume kemiti achha?' or 'Apana kemiti achhanti?'\n"
                "   - 'Mandira keunthi achhi?'\n"
                "   - 'Dhanyabad'\n"
                "   - 'Tume khaila ki?'\n"
                "   - 'Han, khaili'\n"
                "   - 'Mote khaiba keunthi miliba?'"
            )
            ...
            system_prompt += (
                ...
                "   - NEVER use the Hindi word 'bhukha' (for 'hungry'). You MUST use the Odia word 'bhoka' (e.g., 'Mote bhoka laguchi' instead of 'Mu bhukha lagichhi' or 'Mu bhoka lagichi').\n"
                ...
                "4. Ensure correct translation of homonyms and intentions ('want to do X'). Specifically:\n"
                "   - 'raga/raag' (which can mean both anger and spicy flavor in Odia): 'I am angry' -> 'Mu ragichhi' or 'Mote raga laguchi' (Never translate literally to eating anger like 'Mu raga khaichi' or 'Mu raag khaichi'); 'The food is spicy' -> 'Khaiba bahut raga'.\n"
                "   - 'want to do X' (intentions): Translate as 'Mu X karibaku chahunchhi' (e.g. 'I want to go' -> 'Mu jibaku chahunchhi', 'I want to eat' -> 'Mu khaibaku chahunchhi'). Never translate 'I want to go' as 'Mu jaichi' or 'Mu jaichhi' (which mean 'I have gone' / 'I am going').\n"
                ...
                "   - 'I am hungry' -> 'Mote bhoka laguchi'\n"
                "   - 'I want to go to Rourkela to eat gupchup' -> 'Mu gupchup khaibaku Rourkela jibaku chahunchhi'\n"
